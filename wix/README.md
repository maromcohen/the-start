...
| `08-legal-css.html` | HEAD | סגנונות כפתור נגישות, פאנל נגישות, מודל הצהרת נגישות | ✅ חי (CD Legal CSS) |
| `09-legal-js.html` | BODY_END | כפתור נגישות + 7 אפשרויות, הצהרת נגישות (תקנון ופרטיות דרך Wix) | ✅ חי (CD Legal JS) |
